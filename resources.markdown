...
- [MIVIA Large and Dense Graphs LDG](https://mivia.unisa.it/datasets/graph-database/mivia2-graph-database/)
- [MIVIA Graph IoT Network Traffic](https://mivia.unisa.it/datasets/iot-network-analysis/)
- [GREYC's Chemistry dataset](https://lucbrun.ensicaen.fr/CHEMISTRY/)

# Algorithm and Libraries Repositories
- [VF3](https://github.com/MiviaLab/vf3lib)
